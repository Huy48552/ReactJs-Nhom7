        ...
        <div className='home'>
                ...
                <article className='home-about-content'>
                    <section className='home-about-content-item'>
                        <div>
                            ...
                            <p>
                                While we stay true to the traditional recipes
                                and the relaxed atmosphere, our restaurant also
                                aspires to constantly add fusion-style.
                            </p>
                            <h2>
                                “Bettaso restaurant is just like life: a working
                                mix of old and new approaches, but in culinary
                                business.”
                            </h2>
                        </div>
                ...
                <section className='slide-item'>
                    <div className='slide-item-overlay'>
                        <div className='slide-item-content'>
                            <h1>Startes</h1>
                            <p>
                                The start of any meal is so important... So
                                brace your appetite, while waiting for your main
                                course. Our diverse and delicious appetizers
                ...
                <section className='slide-item'>
                    <div className='slide-item-overlay'>
                        <div className='slide-item-content'>
                            <h1>Main Courses</h1>
                            <p>
                                Bettaso's menu knows no borders and
                                nationalities. At the core of our main courses
                                roaster, we have the idea of a cosmopolitan,
                                contemporary cuisine. So whether you'll pick a
                                meat, fish or vegetarian main course, be sure
                                that it will be universally good!...
                            </p>
                        </div>
                    </div>
                ...
                <section className='slide-item'>
                    <div className='slide-item-overlay'>
                        <div className='slide-item-content'>
                            <h1>Desserts</h1>
                            <p>
                                That sweet taste of a dessert at the end of the
                                meal... If you look forward to it too, then
                                you're at the right place! Our menu has prolific
                                choice of desserts. It can make even the
                                prolific sweet tooth person happy!...
                            </p>
                        </div>
                    </div>
                ...
                <section className='slide-item'>
                    <div className='slide-item-overlay'>
                        <div className='slide-item-content'>
                            <h1>Drinks</h1>
                            <p>
                                Refresh yourself while enjoying a flavorsome
                                dinner or a lunch at our place. We at the
                                Bettaso offer different beverages as well as
                                spirits, and liquors!...
                            </p>
                        </div>
                    </div>
            ...
            <div className='home-chef'>
                <div className='chef-info'>
                    ...
                    <p>
                        The team that works at our kitchen, values diversity.{' '}
                        <br></br>
                        We can offer you a traditional dish with nouvelle
                        ingredients!
                    </p>
